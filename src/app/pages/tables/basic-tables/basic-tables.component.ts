...
import { BasicTableFourExampleComponent } from '../../../shared/components/tables/basic-tables/basic-table-four/basic-table-four-example.component';
...
@Component({
  ...
  imports: [
    ...
    BasicTableFourExampleComponent,
