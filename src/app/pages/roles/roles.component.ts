...
export class RolesComponent {
  ...
  rolesData: Role[] = [
    ...
    },
    {
      id: 3,
      name: 'Manager',
      description: 'Management access to oversee operations',
      permissions: 25,
      status: 'Active',
  ...
  columns: TableColumn<Role>[] = [
    ...
    },
    {
      ...
      label: 'Permissions',
      sortable: true,
      render: (item) => `${item.permissions} permissions`,
    },
    {
      key: 'status',
      label: 'Status',
  ...
  onSelectionChange(selected: Role[]) {
    console.log('Selection changed:', selected);
  }

  onActionClick(event: { action: string; item: Role }) {
