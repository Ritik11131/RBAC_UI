...
export class EntitiesComponent {
  ...
  entitiesData: Entity[] = [
    {
      ...
      name: 'User',
      type: 'Core',
      description: 'User entity for managing system users',
      status: 'Active',
    ...
    },
    {
      ...
      name: 'Role',
      type: 'Core',
      description: 'Role entity for defining user roles',
      status: 'Active',
    ...
    },
    {
      ...
      name: 'Permission',
      type: 'Core',
      description: 'Permission entity for access control',
      status: 'Active',
    ...
    },
    {
      ...
      name: 'Module',
      type: 'System',
      description: 'Module entity for system modules',
      status: 'Active',
    ...
    },
    {
      ...
      name: 'Meter',
      type: 'Business',
      description: 'Meter entity for meter management',
      status: 'Pending',
    ...
    },
    {
      ...
      name: 'Audit Log',
      type: 'System',
      description: 'Audit log entity for tracking changes',
      status: 'Active',
    ...
    },
    {
      ...
      name: 'Configuration',
      type: 'System',
      description: 'Configuration entity for system settings',
      status: 'Inactive',
      module: 'System Management',
  ...
  onActionClick(event: { action: string; item: Entity }) {
