...
export class ProfilesComponent {
  ...
  profilesData: Profile[] = [
    {
      ...
      status: 'Active',
      lastActive: '2024-01-24 10:30 AM',
    ...
    },
    {
      ...
      department: 'Sales',
      status: 'Active',
      lastActive: '2024-01-24 09:15 AM',
    ...
    },
    {
      ...
      status: 'Active',
      lastActive: '2024-01-23 04:20 PM',
    ...
    },
    {
      ...
      department: 'Finance',
      status: 'Active',
      lastActive: '2024-01-24 08:00 AM',
    ...
    },
    {
      ...
      status: 'Inactive',
      lastActive: '2024-01-20 02:45 PM',
  ...
  onSelectionChange(selected: Profile[]) {
    console.log('Selection changed:', selected);
  }

  onActionClick(event: { action: string; item: Profile }) {
